...
> HW3_JS.js     
 ...
 3. Реализуйте считывание JSONки из файла с помощью, например, модуля fs для дальнейшего использования в функции, описанной в предыдущем задании.
 ...
 5. Дан разноуровневый массив объектов. Очень похожий на массив из 4го задания, только количество вложенностей может быть не ограничено.    
